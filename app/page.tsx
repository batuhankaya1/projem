...
export default function LanguageEntry() {
  ...
  return <main className="language-entry"><span className="brand-symbol" aria-hidden="true">∿</span><h1>[PROJE ADI]</h1><p>2007 — Bugün / Today</p><nav aria-label="Dil / Language"><Link href="/tr">Türkçe</Link><Link href="/en">English</Link></nav></main>;
}
