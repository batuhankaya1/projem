...
export default function LanguageEntry() {
  ...
  return <main className="language-entry"><img className="language-entry-logo" src="/images/projem-main-logo-transparent.png" alt="Projem Lider Gençlik" width="1921" height="819"/><p>2007 — Bugün / Today</p><nav aria-label="Dil / Language"><Link href="/tr" onClick={() => remember('tr')}>Türkçe</Link><Link href="/en" onClick={() => remember('en')}>English</Link></nav></main>;
}
